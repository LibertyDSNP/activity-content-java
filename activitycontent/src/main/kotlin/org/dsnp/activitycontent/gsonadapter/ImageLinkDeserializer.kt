...
import org.dsnp.activitycontent.model.ConcreteActivityContentImageLink
import java.lang.reflect.Type

/**
 * Converts JSON into an [ActivityContentImageLink].
 ...
 */
open class ImageLinkDeserializer(
    private val supportAdditionalFields: Boolean,
    private val gsonFactory: () -> Gson,
) : JsonDeserializer<ActivityContentImageLink> {
    override fun deserialize(
        ...
        return gsonFactory()
            .fromJson(json, ConcreteActivityContentImageLink::class.java)
            .apply {
