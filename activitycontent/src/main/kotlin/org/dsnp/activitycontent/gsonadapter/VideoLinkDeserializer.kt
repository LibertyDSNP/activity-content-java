...
import org.dsnp.activitycontent.model.ConcreteActivityContentVideoLink
import java.lang.reflect.Type

/**
 * Converts JSON into an [ActivityContentVideoLink].
 ...
 */
open class VideoLinkDeserializer(
    private val supportAdditionalFields: Boolean,
    private val gsonFactory: () -> Gson,
) : JsonDeserializer<ActivityContentVideoLink> {
    override fun deserialize(
        ...
        return gsonFactory()
            .fromJson(json, ConcreteActivityContentVideoLink::class.java)
            .apply {
