...
import org.dsnp.activitycontent.model.ConcreteActivityContentAudioLink
import java.lang.reflect.Type

/**
 * Converts JSON into an [ActivityContentAudioLink].
 ...
 */
open class AudioLinkDeserializer(
    private val supportAdditionalFields: Boolean,
    private val gsonFactory: () -> Gson,
) : JsonDeserializer<ActivityContentAudioLink> {
    override fun deserialize(
        ...
        return gsonFactory()
            .fromJson(json, ConcreteActivityContentAudioLink::class.java)
            .apply {
