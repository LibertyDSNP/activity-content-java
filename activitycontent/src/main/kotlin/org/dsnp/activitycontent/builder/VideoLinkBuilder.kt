 ...
 *
 * @property mediaType The MIME type ([ActivityContentVideoLink.MediaType]) of the video link.
 ...
 */
class VideoLinkBuilder(
    private val mediaType: ActivityContentVideoLink.MediaType,
    ...
    /**
     * Sets the height of the video that this [VideoLinkBuilder] links to.
     *
     * @param height Height of the video.
     * @return The [VideoLinkBuilder] object to be used for chaining method calls.
     */
    fun withHeight(height: Int): VideoLinkBuilder {
        this.height = height
        return this
    }

    /**
     * Sets the width of the video that this [VideoLinkBuilder] links to.
     *
     * @param width Width of the video
     * @return The [AudioLinkBuilder] object to be used for chaining method calls.
     */
    fun withWidth(width: Int): VideoLinkBuilder {
        this.width = width
        return this
    }
     ...
     * @return The [VideoLinkBuilder] object to be used for chaining method calls.
     */
    fun addHash(hash: ActivityContentHash): VideoLinkBuilder {
        this.hash.add(hash)
        return this
    }
     ...
     * @return The [VideoLinkBuilder] object to be used for chaining method calls.
     */
    fun addAdditionalField(name: String, value: Any): VideoLinkBuilder {
     ...
     * @return The [VideoLinkBuilder] object to be used for chaining method calls.
     */
    fun addAdditionalFields(additionalFields: Map<String, Any>): VideoLinkBuilder {
    ...
    fun build(): ActivityContentVideoLink {
        val link = ConcreteActivityContentVideoLink(mediaType, hash, href, height, width, additionalFields = additionalFields)
        link.validate()
        return link
    }
}