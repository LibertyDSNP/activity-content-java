...
class ActivityContentNoteTests {
    @Test
    fun getType() {
        class ExampleActivityContentNote(
            ...
            override val attachment: List<ActivityContentAttachment>? = null
        ) : ActivityContentNote {
        ...
        val note = ExampleActivityContentNote(
            "test content",
            "https://www.w3.org/ns/activitystreams"
        )
        assertThat(note.type).isEqualTo("Note")
        assertThat(note.mediaType).isEqualTo("text/plain")
    }
}